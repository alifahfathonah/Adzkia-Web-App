...
<div class="box-isi-content">
  ...
  <div class="isi_soal">
    ...
    <?php include "include/koneksi.php";
        ...
        echo "<b>Berdasarkan informasi yang diberikan, pilihlah kemungkinan kesimpulan yang paling tepat</b>"; 
       
       $r=1;
       if($hal==1)
       {
         $i="SELECT * from jwb_try j, soal_try s where j.id_soaltry=s.id_soaltry and s.status='10' and j.id_siswa='$siswa' and j.id_jadwaltry='$jadwal'";
       ...
       $i="SELECT * from soal_try where status='10'";
   ...
   <a href='?p=include/penalaran.php&hal=1&jadwal=<?php echo $jadwal; ?>&siswa=<?php echo $siswa; ?>' aria-label='Previous'>
