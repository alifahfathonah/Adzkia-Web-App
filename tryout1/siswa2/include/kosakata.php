...
<div class="box-isi-content">
  ...
  <br><form method="post" action="include/kosakata_proses.php">
  ...
  <div class="isi_soal">
    ...
    <?php 
       ...
       $r=1;
         ...
         $i="SELECT * from jwb_try j, soal_try s where j.id_soaltry=s.id_soaltry and s.status='1' and j.id_siswa='$siswa' and j.id_jadwaltry='$jadwal'";
