...
<div class="box-isi-content">
  ...
  <div class="isi_soal">
    ...
    <?php include "include/koneksi.php";
       ...
       if($hal==1)
       {
         $i="SELECT * from jwb_try j, soal_try s where j.id_soaltry=s.id_soaltry and s.status='5' and j.id_siswa='$siswa' and j.id_jadwaltry='$jadwal'";
        ...
        <?php
        $tt=mysql_query("select * from wacana where id_wacana='1'");
        $rr=mysql_fetch_array($tt);
        ?>
         <tr>
       ...
       $i="SELECT * from soal_try where status='5'";
...
?>
   ...
   <a href='?p=include/analogi.php&hal=1&jadwal=<?php echo $jadwal; ?>&siswa=<?php echo $siswa; ?>' aria-label='Previous'>
