...
<div class="box-isi-content">
  ...
  <br><form action="include/analogi_proses.php" method="post">
  ...
  <div class="isi_soal">
    ...
    <?php include "include/koneksi.php";
       ...
       if($hal==1)
       {
         $i="SELECT * from jwb_try j, soal_try s where j.id_soaltry=s.id_soaltry and s.status='4' and j.id_siswa='$siswa' and j.id_jadwaltry='$jadwal'";
       ...
       $i="SELECT * from soal_try where status='4'";
   ...
   <a href='?p=include/anonim.php&hal=1&jadwal=<?php echo $jadwal; ?>&siswa=<?php echo $siswa; ?>' aria-label='Previous'>
