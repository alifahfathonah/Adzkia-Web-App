...
$new_time = mktime(date('H')+2, date('i'), date('s'), date('m'), date('d'), date('Y'));
...
<script language="javascript">
  	<!--
     	  //  alert('Terima Kasih')
			window.location = "index.php?p=include/kosakata.php&jadwal=<?php echo $jadwal; ?>&siswa=<?php echo $siswa ?>";
