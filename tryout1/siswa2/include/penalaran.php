...
<div class="box-isi-content">
  ...
  <div class="isi_soal">
    ...
    <?php include "include/koneksi.php";
        ...
        echo "<b>Kemampuan Penalaran</b>"; 
       
       $r=1;
       if($hal==1)
       {
         $i="SELECT * from jwb_try j, soal_try s where j.id_soaltry=s.id_soaltry and s.status='9' and j.id_siswa='$siswa' and j.id_jadwaltry='$jadwal'";
        ...
        <?php
        $tt=mysql_query("select * from wacana where id_wacana='4'");
        $rr=mysql_fetch_array($tt);
        ?>
         <tr>
          <td><?php echo $rr[deskripsi]; ?>
          </td>
         </tr>
         <?php
       ...
       $i="SELECT * from soal_try where status='9'";
...
?>
   ...
   <a href='?p=include/kuantitatif.php&hal=1&jadwal=<?php echo $jadwal; ?>&siswa=<?php echo $siswa; ?>' aria-label='Previous'>
