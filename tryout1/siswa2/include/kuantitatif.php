...
<div class="box-isi-content">
  ...
  <div class="isi_soal">
    ...
    <?php include "include/koneksi.php";
        ...
        echo "<b>Kuantitatif</b>"; 
       
       $r=1;
       if($hal==1)
       {
         $i="SELECT * from jwb_try j, soal_try s where j.id_soaltry=s.id_soaltry and s.status='8' and j.id_siswa='$siswa' and j.id_jadwaltry='$jadwal'";
       ...
       $i="SELECT * from soal_try where status='8'";
   ...
   <a href='?p=include/wacana2.php&hal=1&jadwal=<?php echo $jadwal; ?>&siswa=<?php echo $siswa; ?>' aria-label='Previous'>
