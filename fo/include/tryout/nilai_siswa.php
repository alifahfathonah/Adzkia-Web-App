<div class="col-md-12">
  <div class="box">
   ...
   $id = $_REQUEST['id'];
          ...
          $no++;
          $mysql = mysql_query("SELECT * FROM hasil h inner join data_siswa d on h.nis=d.nis where d.nis='$id'");
   ...
   <?php 
     $mysql1 = mysql_query("SELECT * FROM hasil h inner join data_siswa d on h.nis=d.nis where d.nis='$id'");
...
<a href="include/tryout/cetak.php?id=<?php echo $id; ?>">Cetak</a>
