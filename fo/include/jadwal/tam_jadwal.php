     ...
     <div class="form-group">
      ...
      <table id="example1" class="table table-bordered table-striped">
        ...
        <?php
          ...
          $no++;
          $mysql = mysql_query("SELECT * FROM kelas k inner join ruangan r on k.id_ruangan=r.id_ruangan inner join gelombang g on k.id_gel=g.id_gel inner join paket p on k.id_paket=p.id_paket inner join tahun_ajaran ta on k.id_ta=ta.id_ta where ta.status='aktif' and k.id_kantor='$kantor' GROUP BY k.id_paket ");
