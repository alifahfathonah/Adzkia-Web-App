...
<div class="col-md-12 box-isi1">
  ...
  <div class="box box-primary">
    ...
    <!-- form start -->
    <form role="form" method="post" action="include/siswa/pro_siswa.php" enctype="multipart/form-data">
    ...
    <input type="hidden" name="kd" value="<?php echo $io; ?>">
      <div class="box-body"> 
        ...
        <div class="form-group">
          ...
          { 
            ...
            <label>
              <input type="radio" name="kelas" id="optionsRadios1" 
      ...
      <div class="form-group">
          ...
          <?php $u=mysql_query("select * from tahun_ajaran");
          while($o=mysql_fetch_array($u))
          { 
            $id_ta=$o['id_ta'];
            $ta=$o['ta'];
            ?>
             <option value="<?php echo $id_ta; ?>"><?php echo $ta; ?></option>
