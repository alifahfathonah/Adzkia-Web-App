...
<section>
    <form>
        <input type="hidden" name="p" value="laporan/laporanpembayaran.php">
        <!-- date picker-->
	...
	<form action="include/laporan/print_pembayaran.php" target="_blank">
...
<section>
	<?php include "include/laporan/isipembayaran.php" ?>
</section>
</section><!-- /.content -->
